...
<template>
  <div class="restringida-container">
    <div class="container">
      <div class="restringida-card">
        <div class="icon-section">
          🔒
        </div>
        
        <h1 class="titulo">Área Restringida</h1>
        ...
        <button class="btn btn-primary btn-lg mb-4" @click="handleLogin">
          🔐 Iniciar Sesión con Google
        </button>

        <div class="info-section">
          <h3 class="info-titulo">¿Por qué necesito iniciar sesión?</h3>
          <ul class="info-lista">
            <li>✅ Crear encuestas personalizadas</li>
            <li>✅ Gestionar tus encuestas</li>
            <li>✅ Votar en encuestas públicas</li>
            <li>✅ Ver el historial de tus votaciones</li>
          </ul>
        </div>
        ...
        <div class="links-section">
          ...
          <div class="d-flex gap-3 justify-content-center flex-wrap">
            <a 
              href="https://greenborn.com.ar/politica-privacidad.html" 
              target="_blank" 
              rel="noopener"
              class="link-legal"
            >
            ...
            <a 
              href="https://greenborn.com.ar/condiciones-servicio.html" 
              target="_blank" 
              rel="noopener"
              class="link-legal"
            >
...
.btn-primary:hover {
  ...
  box-shadow: 0 6px 16px rgba(0, 87, 183, 0.4);
}
...
.info-lista li {
  ...
  color: #333;
  padding: 0.5rem 0;
  border-bottom: 1px solid rgba(116, 172, 223, 0.2);
}
